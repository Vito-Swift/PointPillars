...
class PillarEncoder(nn.Module):
    def __init__(self, voxel_size, point_cloud_range, in_channel, out_channel):
        ...
        self.x_l = int(round((point_cloud_range[3] - point_cloud_range[0]) / voxel_size[0]))
        self.y_l = int(round((point_cloud_range[4] - point_cloud_range[1]) / voxel_size[1]))
